...
set PATH=C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin\x86_amd64;%PATH%
set PATH=C:\Program Files (x86)\Microsoft Visual Studio 15.0\VC\bin\x86_amd64;%PATH%
...
MSBuild violetminer.sln /p:Configuration=Release /m /v:d || exit /b 1 
